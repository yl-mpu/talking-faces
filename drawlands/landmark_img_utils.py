...
#     ax.set_facecolor('black') 
    ax.imshow(np.zeros( (frame_size[0], frame_size[1], 3) ))
    ...
    ax.plot([preds[41,0], preds[36,0]], [preds[41,1], preds[36,1]], marker='', markersize=5, linestyle='-', color='red', lw=2)
    ax.plot([preds[47,0], preds[42,0]], [preds[47,1], preds[42,1]], marker='', markersize=5, linestyle='-', color='red', lw=2)
    # outer and inner lip
    ...
    ax.plot([preds[59,0], preds[48,0]], [preds[59,1], preds[48,1]], marker='', markersize=5, linestyle='-', color='purple', lw=2)
    ax.plot([preds[67,0], preds[60,0]], [preds[67,1], preds[60,1]], marker='', markersize=5, linestyle='-', color='pink', lw=2)
    ax.axis('off')
